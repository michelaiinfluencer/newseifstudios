...
// registry, so we redirect every `@higgsfield-ai/icons/*` import to a lucide-react
// shim instead (see src/lib/quanta-lucide-icons.ts). tsconfig.json has the matching
// `paths` entry so type-checking resolves it too.
